...
static esp_err_t Touch_I2C_Probe(i2c_port_t i2c_port, uint8_t dev_addr)
{
    esp_err_t ret;
...
esp_err_t TOUCH_Init(esp_lcd_touch_handle_t *out_tp)
{
    ...
    *out_tp = NULL;
    ...
    ESP_RETURN_ON_ERROR(Touch_I2C_Init(), TAG, "I2C init failed");
    ESP_LOGI(TAG, "I2C initialized successfully");

    ret = Touch_I2C_Probe(I2C_Touch_MASTER_NUM, ESP_LCD_TOUCH_IO_I2C_CST328_ADDRESS);
    if (ret != ESP_OK) {
